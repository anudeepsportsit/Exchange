...
import com.bettorlogic.victoryexch.middlelayer.jbetfairng.enums.MarketBettingType;
import com.bettorlogic.victoryexch.middlelayer.jbetfairng.enums.OrderStatus;

import java.util.Set;


public class MarketFilterTO {
    ...
    private TimeRangeTO marketStartTime;
    ...
    public TimeRangeTO getMarketStartTime() {
        return marketStartTime;
    }

    public void setMarketStartTime(TimeRangeTO marketStartTime) {
